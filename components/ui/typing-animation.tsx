...
export function TypingAnimation({
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- resets the typewriter whenever the target text changes (registry code from @magicui/typing-animation)
    setDisplayedText("")
